    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4 text-gray-300 leading-relaxed">
          ...
          <p>1.1. Настоящее Пользовательское соглашение (далее — «Соглашение») регулирует порядок использования онлайн-сервиса https://t.me/EvolveVpnBot (далее — «Сервис»), предоставляемого Администрацией.</p>
          ...
          <p><strong>2. Характер услуг и цифровых товаров</strong></p>
          ...
          <p>2.2. Материалы, предоставляемые через Сервис, могут включать:<br />
          информацию из открытых источников;<br />
          ...
          <p><strong>3. Отказ от гарантий и ответственности</strong></p>
          <p>3.1. Сервис предоставляется на условиях «AS IS» («как есть»).</p>
          <p>3.2. Администрация не гарантирует:<br />
          соответствие Сервиса ожиданиям Пользователя;<br />
          ...
          <p>3.3. Администрация не несёт ответственности за:<br />
          любые прямые или косвенные убытки, включая упущенную выгоду;<br />
          ...
          <p><strong>4. Законность использования</strong></p>
          ...
          <p><strong>6. Ограничение доступа</strong></p>
          <p>6.1. Администрация вправе приостановить или ограничить доступ Пользователя к Сервису в случае:<br />
          нарушения условий настоящего Соглашения;<br />
          ...
          <p><strong>7. Платежи и возвраты</strong></p>
          ...
          <p>7.3. Возврат средств возможен только если:<br />
          услуга не была оказана по технической вине Сервиса;<br />
          ...
          <p><strong>9. Изменение условий</strong></p>
          ...
          <p><strong>10. Контактная информация</strong></p>
          <p>10.1. По всем вопросам Пользователь может обратиться в службу поддержки через форму в самом боте.</p>
          <p className="mt-4">Используя Сервис (в том числе запуская бота и/или вводя команду /start), Пользователь подтверждает, что ознакомлен с настоящим Соглашением и принимает его условия в полном объёме.</p>
